...
```bash
git clone https://github.com/JohnDoe/mac_pde_solver.git
cd mac_pde_solver
git remote add upstream https://github.com/JohanMabille/mac_pde_solver.git
```
...
First, be sure you master is up to date; on your remote fork on github (here `JohnDoe/mac_pde_solver`)
you should see `This branch is even with JohanMabille/mac_pde_solver`. If not, you need to update:
